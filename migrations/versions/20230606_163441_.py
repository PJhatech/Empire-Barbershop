...
Revision ID: 3c122fe86955
Revises: ffdc0a98111c
Create Date: 2023-06-06 16:34:41.301875
...
def upgrade():
    ...
    with op.batch_alter_table('users', schema=None) as batch_op:
        batch_op.add_column(sa.Column('user_type', sa.Enum('barber', 'client', name='user_type_enum'), nullable=True))
