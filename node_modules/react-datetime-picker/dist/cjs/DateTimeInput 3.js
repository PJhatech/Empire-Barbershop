...
var NativeInput_1 = __importDefault(require("./DateTimeInput/NativeInput"));
...
function getDetailValue(_a, index) {
    ...
    return (0, utils_1.between)(valuePiece, minDate, maxDate);
}
...
function DateTimeInput(_a) {
    ...
    var datePlaceholder = (function () {
        ...
        var formattedDate = (0, dateFormatter_1.formatDate)(locale, date);
    ...
    function renderNativeInput() {
        return (react_1.default.createElement(NativeInput_1.default, { key: "datetime", ariaLabel: nativeInputAriaLabel, disabled: disabled, maxDate: maxDate || defaultMaxDate, minDate: minDate || defaultMinDate, name: name, onChange: onChangeNative, required: required, value: value, valueType: valueType }));
    }
    return (
...
DateTimeInput.propTypes = {
    ...
    isWidgetOpen: prop_types_1.default.bool,
